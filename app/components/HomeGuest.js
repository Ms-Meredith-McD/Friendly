...
function HomeGuest() {
  ...
  // validation for at least 3 characters in username
  useEffect(() => {
  ...
  // validate email address is correct formal
  useEffect(() => {
  ...
  // validate that email address is not already in use
  useEffect(() => {
